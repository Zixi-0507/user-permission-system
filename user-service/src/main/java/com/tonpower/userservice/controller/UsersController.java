...
public class UsersController {
     ...
     */
    @GetMapping("/list/all")
    public BaseResponse<Page<UserVO>> listUserAllByPage(@RequestBody UsersQueryRequest usersQueryRequest){
    ...
    public BaseResponse<Page<UserVO>> listUserByPage(@RequestBody UsersQueryRequest usersQueryRequest){
